...
<html lang="pl">
  <head>
    ...
    <title>Note Taking :: Register to get your notebook</title>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-4 offset-md-4">
              <h1>Register</h1>
              <form method="post" action="<?= SITE_PATH; ?>register/registerAction">
                ...
                <div class="col-12 col-md-12 mb-3 input-group">
                  ...
                  <input type="password" class="form-control" placeholder="Retype Password" aria-label="Retype Password" name="rePassword">
                </div>
                <div class="col-12 col-md-12 mb-3 input-group">
                  <button class="btn btn-red" type="submit" name="register">Register</button>
                </div>
                <div class="col-12 center">
                  <a href="<?= SITE_PATH; ?>login">You have account?</a>
                </div>
              </form>
            </div>
          </div>
